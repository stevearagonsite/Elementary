...
namespace Mewlist
{
    public abstract class AbstractMassiveCloudsEditor : Editor
    {
        protected void ProfileGUI(SerializedProperty parameter)
        {
            ...
            Section("Height Fog Parameters", () =>
            {
                var heightFog = parameter.FindPropertyRelative("HeightFog").boolValue;
                EditorGUILayout.PropertyField(parameter.FindPropertyRelative("HeightFog"));
                if (heightFog)
                {
                    EditorGUILayout.PropertyField(parameter.FindPropertyRelative("GroundHeight"));
                    EditorGUILayout.PropertyField(parameter.FindPropertyRelative("HeightFogFromDistance"));
                    EditorGUILayout.PropertyField(parameter.FindPropertyRelative("HeightFogRange"));
                }
            });
