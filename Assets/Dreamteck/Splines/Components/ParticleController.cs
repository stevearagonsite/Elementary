namespace Dreamteck.Splines
{
    ...
    public class ParticleController : SplineUser
    {
        ...
        void HandleParticle(int index)
        {
            ...
            {
                Evaluate(evalResult, UnclipPercent(controllers[index].GetSplinePercent(wrapMode, particles[index])));
            ...
            //if(particles[index].remainingLifetime > controllers[index].remainingLifetime) particles[index].remainingLifetime = controllers[index].remainingLifetime;
        }
        ...
        void OnParticleBorn(int index)
        {
            ...
            Evaluate(evalResult, UnclipPercent(percent));
